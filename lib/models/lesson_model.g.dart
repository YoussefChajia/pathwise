...
void _lessonSerialize(
  ...
  writer.writeLong(offsets[2], object.estimatedDuration);
...
Lesson _lessonDeserialize(
  ...
  final object = Lesson(
    ...
    estimatedDuration: reader.readLongOrNull(offsets[2]),
    isCompleted: reader.readBoolOrNull(offsets[3]) ?? false,
    progress: reader.readDoubleOrNull(offsets[4]) ?? 0.0,
...
extension LessonQueryFilter on QueryBuilder<Lesson, Lesson, QFilterCondition> {
  ...
  QueryBuilder<Lesson, Lesson, QAfterFilterCondition> descriptionIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Lesson, Lesson, QAfterFilterCondition> descriptionIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Lesson, Lesson, QAfterFilterCondition> estimatedDurationEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'estimatedDuration',
  ...
  QueryBuilder<Lesson, Lesson, QAfterFilterCondition> estimatedDurationLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Lesson, Lesson, QAfterFilterCondition> estimatedDurationBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Lesson, Lesson, QAfterFilterCondition> progressEqualTo(
    double value, {
  ...
  QueryBuilder<Lesson, Lesson, QAfterFilterCondition> progressGreaterThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Lesson, Lesson, QAfterFilterCondition> progressLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Lesson, Lesson, QAfterFilterCondition> progressBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Lesson, Lesson, QAfterFilterCondition> updatedAtIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<Lesson, Lesson, QAfterFilterCondition> updatedAtIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'updatedAt',
      ));
...
extension LessonQueryLinks on QueryBuilder<Lesson, Lesson, QFilterCondition> {
  QueryBuilder<Lesson, Lesson, QAfterFilterCondition> module(
  ...
  QueryBuilder<Lesson, Lesson, QAfterFilterCondition> moduleIsNull() {
    return QueryBuilder.apply(this, (query) {
...
extension LessonQuerySortBy on QueryBuilder<Lesson, Lesson, QSortBy> {
  ...
  QueryBuilder<Lesson, Lesson, QAfterSortBy> sortByEstimatedDuration() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'estimatedDuration', Sort.asc);
    });
  }

  QueryBuilder<Lesson, Lesson, QAfterSortBy> sortByEstimatedDurationDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Lesson, Lesson, QAfterSortBy> sortByProgress() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'progress', Sort.asc);
    });
  }

  QueryBuilder<Lesson, Lesson, QAfterSortBy> sortByProgressDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension LessonQuerySortThenBy on QueryBuilder<Lesson, Lesson, QSortThenBy> {
  ...
  QueryBuilder<Lesson, Lesson, QAfterSortBy> thenByEstimatedDuration() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'estimatedDuration', Sort.asc);
    });
  }

  QueryBuilder<Lesson, Lesson, QAfterSortBy> thenByEstimatedDurationDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'estimatedDuration', Sort.desc);
    });
  }
  ...
  QueryBuilder<Lesson, Lesson, QAfterSortBy> thenByProgress() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'progress', Sort.asc);
    });
  }

  QueryBuilder<Lesson, Lesson, QAfterSortBy> thenByProgressDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'progress', Sort.desc);
    });
  }
...
extension LessonQueryWhereDistinct on QueryBuilder<Lesson, Lesson, QDistinct> {
  ...
  QueryBuilder<Lesson, Lesson, QDistinct> distinctByEstimatedDuration() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Lesson, Lesson, QDistinct> distinctByProgress() {
    return QueryBuilder.apply(this, (query) {
...
extension LessonQueryProperty on QueryBuilder<Lesson, Lesson, QQueryProperty> {
  ...
  QueryBuilder<Lesson, int?, QQueryOperations> estimatedDurationProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Lesson, double, QQueryOperations> progressProperty() {
    return QueryBuilder.apply(this, (query) {
